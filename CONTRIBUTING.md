...
When you're ready to file, [create a GitHub issue](https://github.com/navapbc/labs-assistive-chatbot/issues/new) and include:
...
We're especially interested in feedback from people who work directly with caseworkers or benefit systems. If you have an idea for how this tool could better serve that context, [open a GitHub issue](https://github.com/navapbc/labs-assistive-chatbot/issues/new) with the label `enhancement` and describe:
...
To contribute code, start by forking the repository and setting up your local environment. See the [Getting Started](docs/app/getting-started.md) section in the docs/app for setup instructions.
